...
- ApexRail dispatcher and trigger context.
- Abstract lifecycle handler.
- Ordered action pipeline.
- Action-and-record re-entry guard.
- Transaction-scoped handler bypass.
